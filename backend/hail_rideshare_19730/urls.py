"""hail_rideshare_19730 URL Configuration
...
admin.site.site_header = "Hail Rideshare"
admin.site.site_title = "Hail Rideshare Admin Portal"
admin.site.index_title = "Hail Rideshare Admin"

# swagger
api_info = openapi.Info(
    title="Hail Rideshare API",
    default_version="v1",
    description="API documentation for Hail Rideshare App",
)
